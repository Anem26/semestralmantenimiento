...
#Caso de prueba 15- AGREGAR UN EQUIPO FAVORITO SIN INICIAR SESIÓN [A]
driver.find_element(By.XPATH, '//*[@href="equipos.php"]  ').click()
time.sleep(1)
driver.find_element(By.XPATH, '//*[@src="img/australia.png"] ').click()
time.sleep(1)
